...
/**
 * get_asset_gameplay_effect — 读取 GE Blueprint。
 * sections: policy / modifiers / tags / cues。
 */
class FGetAssetGameplayEffectCapability : public FNexusMultiSectionCapability
{
protected:
